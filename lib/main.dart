...
class _FluffyAppHomeState extends State<FluffyAppHome> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    double xPos = ((MediaQuery.of(context).size.width / squareDim) / 2); // - ((1 / (squareDim / 2)));
